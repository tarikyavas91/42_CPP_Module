...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/27 14:57:24 by tyavas            #+#    #+#             */
/*   Updated: 2023/05/29 16:01:11 by tyavas           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void        PhoneBook::display(PhoneBook pb)
{
    ...
    std::cout << "|-------------------------------------------|" << std::endl;
    std::cout << "|     \033[36mIndex\033[0m|" << "\033[36mFirst name\033[0m|" << " \033[36mLast name\033[0m|" << " \033[36mNickname\033[0m|" << std::endl;
    std::cout << "|-------------------------------------------|" << std::endl;
    while (i < 8)
    {
        if (pb.contacts[i].isnull(pb.contacts[i]))
